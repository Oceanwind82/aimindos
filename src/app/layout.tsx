      ...
      <header className="border-b border-white/10">
        <div className="mx-auto flex h-14 max-w-screen-xl items-center justify-between px-4">
          ...
          <nav className="flex gap-4 text-sm">
            ...
            <a className="hover:opacity-80" href="/api/health" target="_blank" rel="noopener noreferrer">Core Health</a>
            <a className="hover:opacity-80" href="/api/sanity/health" target="_blank" rel="noopener noreferrer">Sanity Health</a>
          </nav>
        </div>
      </header>
